...
function BookContents({ props }) {
    ...
    console.log(/*[*/ [fullRows, props.type] /*, totalBooks]*/);
    return (
            ...
            <div className="grid gap-6 row-gap-5 lg:grid-cols-3">
                <div>
                    ...
                    <p className="text-gray-700">
                        O for awesome, this chocka full cuzzie is as rip-off as
                        a cracker. Meanwhile, in behind the bicycle shed,
                        Hercules Morse.
                    </p>
                </div>
                <div>
                    ...
                    <p className="text-gray-700">
                        ...
                        android's bottom, eh, Data? When has justice ever been
                ...
                <div>
                    ...
                    <p className="text-gray-700">
                        ...
                        Ut ac suscipit leo. Carpe diem vulputate est nec commodo
                        rutrum.
                    </p>
                </div>
            </div>
